...
func (t *writeFileTool) Call(argsJSON string) (string, error) {
	...
	// to the persistence class, and content sniffing catches
...
func (t *patchTool) Call(argsJSON string) (string, error) {
	...
	// deferred-execution targets escalate to persistence, and the
...
Replaces shell stat / du / ls -l metadata checks — exact bytes + mode.
